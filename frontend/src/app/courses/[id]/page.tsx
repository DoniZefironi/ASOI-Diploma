    ...
    <div className="min-h-screen bg-[#0D1117] py-12">
      <div className="container mx-auto px-4">
        ...
        {userGroup && (
          <div className="bg-[#161B22] rounded-xl p-8 border border-gray-700 mb-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-white">📖 Моя группа</h2>
            ...
            <div className="mb-6">
              <div className="text-xl font-semibold text-white mb-2">{userGroup.name}</div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {/* Рейтинг студентов */}
              <div>
                <h3 className="text-lg font-semibold text-white mb-4">🏆 Рейтинг группы</h3>
                <StudentRatingList groupId={userGroup.id} />
              </div>

              {/* Расписание */}
              <div>
                <h3 className="text-lg font-semibold text-white mb-4">📅 Расписание</h3>
        ...
        <div className="bg-[#161B22] rounded-xl p-8 border border-gray-700">
          <h2 className="text-2xl font-bold text-white mb-6">📋 Доступные группы</h2>
          ...
          {groups.length === 0 ? (
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {groups.map((group) => {
                ...
                return (
                  <div key={group.id} className="bg-[#0D1117] rounded-lg p-6 border border-gray-700">
  ...
  return (
    <div className="space-y-2">
      {students.slice(0, 5).map((student, index) => (
        <div key={student.id} className="flex justify-between items-center p-3 bg-[#0D1117] rounded-lg">
    ...
    <div className="space-y-2">
      {schedule.slice(0, 5).map((item) => (
        <Link
          ...
          className="block p-3 bg-[#0D1117] rounded-lg hover:bg-gray-800 transition-colors"
        >
